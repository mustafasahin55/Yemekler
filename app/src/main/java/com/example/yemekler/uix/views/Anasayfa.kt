	...
	Scaffold(bottomBar = { BottomBar() } ,
		...
		LazyColumn(
			...
			item { Spacer(modifier = Modifier.height(10.dp))
				Text(text = "What would you like to order", fontFamily = semiBold, lineHeight = 30.sp,color = dark80, fontSize = 30.sp, modifier = Modifier.padding(start = 35.dp, end =90.dp)) }
			item {Spacer(modifier = Modifier.height(10.dp))
			...
			item {
				Row(modifier = Modifier.padding(start = 30.dp), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically){

					Text(text = "Featured Restaurants", lineHeight = 18.sp,color = dark80, fontSize = 18.sp, fontFamily = semiBold)
					Text(text = "View All >", lineHeight = 14.sp, color = orange, fontSize = 14.sp, fontFamily = semiBold, modifier = Modifier.padding(start = 90.dp))
				}
			...
			item{
				LazyRow(modifier = Modifier
					...
					items(restoran.size){
						...
						Image(modifier = Modifier.size(330.dp), painter = painterResource(id = activity.resources.getIdentifier(resim,"drawable",activity.packageName)) , contentDescription = "")
...
fun topBar()
{
	TopAppBar(title = {
		...
		Row(modifier = Modifier
			.fillMaxWidth()
			.padding(end = 12.dp), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween) {
			Image(
			...
			Column(verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
				...
				Text(text = "34418 Nilüfer Sokak" , fontSize = 12.sp, color = orange, lineHeight = 12.sp)
